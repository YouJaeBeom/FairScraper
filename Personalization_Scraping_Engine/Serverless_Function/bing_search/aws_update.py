...
class LambdaUpdater:
    ...
    def update_lambda_functions(self, specific_function_name=None):
        ...
        serverless_function_list = [sf['arn'] for sf in self.serverless_function_json['bing_search']]
        region_list = [region['region'] for region in self.region_json['bing_search']]
